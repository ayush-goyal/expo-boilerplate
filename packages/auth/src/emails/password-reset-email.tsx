      ...
      <Tailwind>
        <Body className="bg-gray-50 py-8" style={main}>
          <Container className="mx-auto max-w-[600px] rounded-lg border border-gray-200 bg-white p-10 shadow-sm">
            ...
            <Text className="my-4 text-base leading-6 text-gray-700">Hello,</Text>
            <Text className="my-4 text-base leading-6 text-gray-700">
              We received a request to reset your password. Use the button below to set a new
              password. This link is valid for 1 hour.
            </Text>
